...
```yaml
dependencies:
  vulpes_backend_client: 1.2.0-beta.36
```
...
[*FontApi*](doc/FontApi.md) | [**updateChars**](doc/FontApi.md#updatechars) | **POST** /font/chars/{id} | Update characters of a font
...
[*ItemApi*](doc/ItemApi.md) | [**getEnchantmentsById1**](doc/ItemApi.md#getenchantmentsbyid1) | **GET** /item/{id}/enchantments | Get enchantments of an item
[*ItemApi*](doc/ItemApi.md) | [**getFlagsById**](doc/ItemApi.md#getflagsbyid) | **GET** /item/flags/{id} | Get all flags of an item
[*ItemApi*](doc/ItemApi.md) | [**getFlagsById1**](doc/ItemApi.md#getflagsbyid1) | **GET** /item/{id}/flags | Get all flags of an item
...
[*ItemApi*](doc/ItemApi.md) | [**getLoreById1**](doc/ItemApi.md#getlorebyid1) | **GET** /item/{id}/lore | Get all lore of an item
...
[*ItemApi*](doc/ItemApi.md) | [**updateEnchantments**](doc/ItemApi.md#updateenchantments) | **POST** /item/enchantments/{id} | Update enchantments of an item
[*ItemApi*](doc/ItemApi.md) | [**updateEnchantments1**](doc/ItemApi.md#updateenchantments1) | **POST** /item/{id}/enchantments | Update enchantments of an item
[*ItemApi*](doc/ItemApi.md) | [**updateFlags**](doc/ItemApi.md#updateflags) | **POST** /item/flags/{id} | Update flags of an item
[*ItemApi*](doc/ItemApi.md) | [**updateFlags1**](doc/ItemApi.md#updateflags1) | **POST** /item/{id}/flags | Update flags of an item
[*ItemApi*](doc/ItemApi.md) | [**updateLore**](doc/ItemApi.md#updatelore) | **POST** /item/lore/{id} | Update lore of an item
[*ItemApi*](doc/ItemApi.md) | [**updateLore1**](doc/ItemApi.md#updatelore1) | **POST** /item/{id}/lore | Update lore of an item
...
[*SoundApi*](doc/SoundApi.md) | [**deleteLinkedSoundFileSource**](doc/SoundApi.md#deletelinkedsoundfilesource) | **DELETE** /sound/{id}/sources/delete/{soundId} | Delete a linked SoundFileSource
...
## Documentation For Models
 ...
 - [ResponseEnchantmentDTO](doc/ResponseEnchantmentDTO.md)
