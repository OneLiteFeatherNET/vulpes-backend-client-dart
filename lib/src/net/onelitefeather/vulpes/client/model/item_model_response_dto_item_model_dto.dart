...
part 'item_model_response_dto_item_model_dto.g.dart';
...
@BuiltValue()
abstract class ItemModelResponseDTOItemModelDTO implements Built<ItemModelResponseDTOItemModelDTO, ItemModelResponseDTOItemModelDTOBuilder> {
  /// The id of the model
  ...
  ItemModelResponseDTOItemModelDTO._();

  factory ItemModelResponseDTOItemModelDTO([void updates(ItemModelResponseDTOItemModelDTOBuilder b)]) = _$ItemModelResponseDTOItemModelDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ItemModelResponseDTOItemModelDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ItemModelResponseDTOItemModelDTO> get serializer => _$ItemModelResponseDTOItemModelDTOSerializer();
}

class _$ItemModelResponseDTOItemModelDTOSerializer implements PrimitiveSerializer<ItemModelResponseDTOItemModelDTO> {
  @override
  final Iterable<Type> types = const [ItemModelResponseDTOItemModelDTO, _$ItemModelResponseDTOItemModelDTO];

  @override
  final String wireName = r'ItemModelResponseDTOItemModelDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ItemModelResponseDTOItemModelDTO object, {
  ...
  void _deserializeProperties(
    ...
    required ItemModelResponseDTOItemModelDTOBuilder result,
  ...
  @override
  ItemModelResponseDTOItemModelDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ItemModelResponseDTOItemModelDTOBuilder();
