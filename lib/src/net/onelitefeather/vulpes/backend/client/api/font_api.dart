...
class FontApi {
  ...
  Future<Response<ResponseFontModelDTO>> deleteFont({ 
    ...
    final _path = r'/font/delete/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ResponseFontModelCharsDTO>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ResponseFontModelCharsDTO>>> updateChars({ 
    required String id,
    ...
    BuiltList<ResponseFontModelCharsDTO>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ResponseFontModelCharsDTO)]),
      ) as BuiltList<ResponseFontModelCharsDTO>;
    ...
    return Response<BuiltList<ResponseFontModelCharsDTO>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
