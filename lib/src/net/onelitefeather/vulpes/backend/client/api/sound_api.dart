...
class SoundApi {
  ...
  const SoundApi(this._dio, this._serializers);
  ...
  Future<Response<ResponseSoundModelDTO>> addSoundEvent({ 
    ...
    try {
      const _type = FullType(SoundEventDTO);
      _bodyData = _serializers.serialize(soundEventDTO, specifiedType: _type);
  ...
  Future<Response<ResponseSoundModelDTO>> deleteAllSoundEvents({ 
    ...
    final _path = r'/sound/delete/all';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ResponseSoundModelDTO>> getSoundById({ 
    ...
    final _path = r'/sound/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<ResponseSoundModelDTO>> removeSoundEventById({ 
    ...
    final _path = r'/sound/delete/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
