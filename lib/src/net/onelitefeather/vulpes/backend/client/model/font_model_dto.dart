...
abstract class FontModelDTO implements Built<FontModelDTO, FontModelDTOBuilder> {
  ...
  factory FontModelDTO([void updates(FontModelDTOBuilder b)]) = _$FontModelDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FontModelDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<FontModelDTO> get serializer => _$FontModelDTOSerializer();
}

class _$FontModelDTOSerializer implements PrimitiveSerializer<FontModelDTO> {
  @override
  final Iterable<Type> types = const [FontModelDTO, _$FontModelDTO];

  @override
  final String wireName = r'FontModelDTO';
  ...
  void _deserializeProperties(
    ...
    required FontModelDTOBuilder result,
  ...
  @override
  FontModelDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = FontModelDTOBuilder();
