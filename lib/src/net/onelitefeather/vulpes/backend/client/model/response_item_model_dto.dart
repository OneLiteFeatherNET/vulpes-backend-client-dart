...
part 'response_item_model_dto.g.dart';
...
@BuiltValue()
abstract class ResponseItemModelDTO implements Built<ResponseItemModelDTO, ResponseItemModelDTOBuilder> {
  /// The id of the model
  ...
  ResponseItemModelDTO._();

  factory ResponseItemModelDTO([void updates(ResponseItemModelDTOBuilder b)]) = _$ResponseItemModelDTO;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ResponseItemModelDTOBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ResponseItemModelDTO> get serializer => _$ResponseItemModelDTOSerializer();
}

class _$ResponseItemModelDTOSerializer implements PrimitiveSerializer<ResponseItemModelDTO> {
  @override
  final Iterable<Type> types = const [ResponseItemModelDTO, _$ResponseItemModelDTO];

  @override
  final String wireName = r'ResponseItemModelDTO';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ResponseItemModelDTO object, {
  ...
  void _deserializeProperties(
    ...
    required ResponseItemModelDTOBuilder result,
  ...
  @override
  ResponseItemModelDTO deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ResponseItemModelDTOBuilder();
