...
@BuiltValue()
abstract class FontModelDTO2 implements Built<FontModelDTO2, FontModelDTO2Builder> {
  /// ID of the mode
  ...
  factory FontModelDTO2([void updates(FontModelDTO2Builder b)]) = _$FontModelDTO2;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FontModelDTO2Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<FontModelDTO2> get serializer => _$FontModelDTO2Serializer();
}

class _$FontModelDTO2Serializer implements PrimitiveSerializer<FontModelDTO2> {
  @override
  final Iterable<Type> types = const [FontModelDTO2, _$FontModelDTO2];

  @override
  final String wireName = r'FontModelDTO2';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    FontModelDTO2 object, {
  ...
  void _deserializeProperties(
    ...
    required FontModelDTO2Builder result,
  ...
  @override
  FontModelDTO2 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = FontModelDTO2Builder();
