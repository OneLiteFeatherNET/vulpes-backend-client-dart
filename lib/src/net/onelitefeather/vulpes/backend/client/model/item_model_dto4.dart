...
@BuiltValue()
abstract class ItemModelDTO4 implements Built<ItemModelDTO4, ItemModelDTO4Builder> {
  /// The id of the model
  ...
  factory ItemModelDTO4([void updates(ItemModelDTO4Builder b)]) = _$ItemModelDTO4;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ItemModelDTO4Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ItemModelDTO4> get serializer => _$ItemModelDTO4Serializer();
}

class _$ItemModelDTO4Serializer implements PrimitiveSerializer<ItemModelDTO4> {
  @override
  final Iterable<Type> types = const [ItemModelDTO4, _$ItemModelDTO4];

  @override
  final String wireName = r'ItemModelDTO4';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ItemModelDTO4 object, {
  ...
  void _deserializeProperties(
    ...
    required ItemModelDTO4Builder result,
  ...
  @override
  ItemModelDTO4 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ItemModelDTO4Builder();
