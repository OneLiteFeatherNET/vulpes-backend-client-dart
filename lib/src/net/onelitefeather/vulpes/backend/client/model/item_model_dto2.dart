...
@BuiltValue()
abstract class ItemModelDTO2 implements Built<ItemModelDTO2, ItemModelDTO2Builder> {
  /// The id of the model
  ...
  factory ItemModelDTO2([void updates(ItemModelDTO2Builder b)]) = _$ItemModelDTO2;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ItemModelDTO2Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ItemModelDTO2> get serializer => _$ItemModelDTO2Serializer();
}

class _$ItemModelDTO2Serializer implements PrimitiveSerializer<ItemModelDTO2> {
  @override
  final Iterable<Type> types = const [ItemModelDTO2, _$ItemModelDTO2];

  @override
  final String wireName = r'ItemModelDTO2';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ItemModelDTO2 object, {
  ...
  void _deserializeProperties(
    ...
    required ItemModelDTO2Builder result,
  ...
  @override
  ItemModelDTO2 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ItemModelDTO2Builder();
