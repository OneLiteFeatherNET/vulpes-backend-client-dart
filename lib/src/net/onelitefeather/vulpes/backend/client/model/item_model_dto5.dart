...
@BuiltValue()
abstract class ItemModelDTO5 implements Built<ItemModelDTO5, ItemModelDTO5Builder> {
  /// The id of the model
  ...
  factory ItemModelDTO5([void updates(ItemModelDTO5Builder b)]) = _$ItemModelDTO5;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ItemModelDTO5Builder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ItemModelDTO5> get serializer => _$ItemModelDTO5Serializer();
}

class _$ItemModelDTO5Serializer implements PrimitiveSerializer<ItemModelDTO5> {
  @override
  final Iterable<Type> types = const [ItemModelDTO5, _$ItemModelDTO5];

  @override
  final String wireName = r'ItemModelDTO5';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ItemModelDTO5 object, {
  ...
  void _deserializeProperties(
    ...
    required ItemModelDTO5Builder result,
  ...
  @override
  ItemModelDTO5 deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ItemModelDTO5Builder();
