...
// tests for ResponseAttributeModelDTO
void main() {
  final instance = ResponseAttributeModelDTOBuilder();
  // TODO add properties to the builder and call build()

  group(ResponseAttributeModelDTO, () {
    ...
    // double maximumValue
    test('to test the property `maximumValue`', () async {
      // TODO
    });
