...
// tests for SoundFileSourceDTO
void main() {
  final instance = SoundFileSourceDTOBuilder();
  ...
  group(SoundFileSourceDTO, () {
    ...
    test('to test the property `attenuationDistance`', () async {
      // TODO
    });

    // bool preload
    test('to test the property `preload`', () async {
      // TODO
    });
